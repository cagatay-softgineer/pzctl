...
Supervisor daemon + web control panel for this Project Zomboid dedicated server.
Pure Python 3.11+ standard library — nothing to install.
...
Launcher tab or by hand (the daemon reads it at startup).
